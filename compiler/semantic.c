...
void semantic_error(int i, int ll, char *s) {
	...
	switch(i) {
		case 13:
			printf("arith type expr required in uary operation\n");
			break;
		case 18:
		...
		case 29:
			...
			break;
		case 31:
			printf("pointer type expr required in pointer operration\n");
			break;
		case 32:
		...
		case 35:
			...
			break;
		case 37:
			printf("illegal struct field identifier in struct refernce expr\n");
			break;
		case 38:
		...
		case 41:
			...
			break;
		case 49:
			printf("scalar type expr require in middle of for-expr\n");
			break;
		case 50:
			printf("integral type expression requiredin statement\n");
			break;
		case 51:
		...
		case 81:
			...
			break;
		case 82:
			printf("illegal array size of type\n");
			break;
		case 83:
		...
		case 85:
			...
			break;
		case 86:
			printf("illegal array size of empty array\n");
			break;
		case 89:
...
void setTypeSize(A_TYPE *t, int size) {
}

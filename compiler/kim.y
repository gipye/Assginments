...
extern void semantic_analysis(A_NODE *);
extern void set_literal_address(A_NODE *);
extern int put_literal(A_LITERAL, int);
extern void sem_program(A_NODE *);
extern A_TYPE *sem_expression(A_NODE *);
extern int sem_statement(A_NODE *, int, A_TYPE *, BOOLEAN, BOOLEAN, BOOLEAN);
extern int sem_statement_list(A_NODE *, int, A_TYPE *, BOOLEAN, BOOLEAN, BOOLEAN);
extern void sem_for_expression(A_NODE *);
extern int sem_A_TYPE(A_TYPE *);
extern int sem_declaration_list(A_ID *, int);
extern int sem_declaration(A_ID *, int);
extern void sem_arg_expr_list(A_NODE *, A_ID *);
extern A_ID *getStructFieldIdentifier(A_TYPE *, char *);
extern A_ID *getPointerFieldIdentifier(A_TYPE *, char *);
extern A_NODE *convertScalarToInteger(A_NODE *);
extern A_NODE *convertUsualAssignmentConversion(A_TYPE *, A_NODE *);
extern A_NODE *convertUsualUnaryConversion(A_NODE *);
extern A_TYPE *convertUsualBinaryConversion(A_NODE *);
extern A_NODE *convertCastingConversion(A_NODE *, A_TYPE *);
extern BOOLEAN isAllowableAssignmentConversion(A_TYPE *, A_TYPE *, A_NODE *);
extern BOOLEAN isAllowableCastingConversion(A_TYPE *, A_TYPE *);
extern BOOLEAN isModifiableLvalue(A_NODE *);
extern BOOLEAN isConstantZeroExp(A_NODE *);
extern BOOLEAN isSameParameterType(A_ID *, A_ID *);
extern BOOLEAN isCompatibleType(A_TYPE *, A_TYPE *);
extern BOOLEAN isCompatiblePointerType(A_TYPE *, A_TYPE *);
extern BOOLEAN isIntType(A_TYPE *);
extern BOOLEAN isFloatType(A_TYPE *);
extern BOOLEAN isArithmeticType(A_TYPE *);
extern BOOLEAN isAnyIntegerType(A_TYPE *);
extern BOOLEAN isIntegralType(A_TYPE *);
extern BOOLEAN isStructOrUnionType(A_TYPE *);
extern BOOLEAN isFunctionType(A_TYPE *);
extern BOOLEAN isScalarType(A_TYPE *);
extern BOOLEAN isPointerType(A_TYPE *);
extern BOOLEAN isPointerOrArrayType(A_TYPE *);
extern BOOLEAN isArrayType(A_TYPE *);
extern BOOLEAN isStringType(A_TYPE *);
extern BOOLEAN isVoidType(A_TYPE *);
extern A_LITERAL checkTypeAndConvertLiteral(A_LITERAL, A_TYPE *, int);
extern A_LITERAL getTypeAndValueOfExpression(A_NODE *);
extern void semantic_warning(int, int);
...
%token	IDENTIFIER TYPE_IDENTIFIER FLOAT_CONSTANT INTEGER_CONSTANT
		CHARACTER_CONSTANT STRING_LITERAL PLUS MINUS PLUSPLUS MINUSMINUS
		BAR AMP BARBAR AMPAMP ARROW SEMICOLON LSS GTR LEQ GEQ EQL NEQ DOTDOTDOT
		LP RP LB RB LR RR PERIOD COMMA EXCL STAR SLASH PERCENT ASSIGN COLON
...
direct_abstract_declarator
	...
	|direct_abstract_declarator LB constant_expression RB { $$ = setTypeElementType($1, setTypeExpr(makeType(T_ARRAY), $3)); }
